...
class ResponseHelper {
    ok(res, statusText, message, data, startTime, extra = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            let exeTime = yield this.execTime(startTime);
            console.log(extra, "extra");
            // data = Array.isArray(data) ? { data } : data;
            res.status(200).json(Object.assign(Object.assign({ status: 200, statusText: statusText ? statusText : "SUCCESS", message: message, data: data }, extra), { exeTime }));
        });
    }
    api(res, status, message, data, startTime) {
        return __awaiter(this, void 0, void 0, function* () {
            let exeTime = yield this.execTime(startTime);
            data = Array.isArray(data) ? data : data;
            res.status(200).json({
    ...
    apiNew(res, status, message, data, startTime) {
        return __awaiter(this, void 0, void 0, function* () {
            let exeTime = yield this.execTime(startTime);
            data = Array.isArray(data) ? data : data;
            res.status(200).json(Object.assign(Object.assign({ status: status, message: message }, data), { exeTime }));
        });
    }
    apiNotFound(res, status, message, data, startTime) {
        return __awaiter(this, void 0, void 0, function* () {
            let exeTime = yield this.execTime(startTime);
            data = Array.isArray(data) ? data : data;
            res.status(404).json(Object.assign(Object.assign({ status: status, message: message }, data), { exeTime }));
        });
    }
