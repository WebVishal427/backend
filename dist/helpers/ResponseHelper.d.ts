declare class ResponseHelper {
    ok(res: any, statusText: string, message: any, data: any, startTime: any, extra?: any): Promise<void>;
    api(res: any, status: boolean, message: any, data: any, startTime: any): Promise<void>;
    apiNew(res: any, status: boolean, message: any, data: any, startTime: any): Promise<void>;
    apiNotFound(res: any, status: boolean, message: any, data: any, startTime: any): Promise<void>;
